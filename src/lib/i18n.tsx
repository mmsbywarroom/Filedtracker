...
const dict = {
  en: {
    ...
    partialFace: "Show full face — forehead to chin inside the circle",
    offCenterFace: "Center your face in the circle",
  ...
  pa: {
    ...
    offCenterFace: "ਚਿਹਰਾ ਗੋਲੇ ਵਿੱਚ ਕੇਂਦਰ ਵਿੱਚ ਰੱਖੋ",
