...
const dict = {
  en: {
    ...
    punchInWindow: "Punch in is allowed from 7:00 AM IST onward (including after 1:00 PM).",
  ...
  pa: {
    ...
    punchInWindow: "ਪੰਚ ਇਨ ਸਵੇਰੇ 7:00 ਵਜੇ ਤੋਂ (IST) ਅੱਗੇ ਮਨਜ਼ੂਰ ਹੈ (ਦੁਪਹਿਰ 1:00 ਤੋਂ ਬਾਅਦ ਵੀ)।",
    ...
    attendanceApprovals: "ਹਾਜ਼ਰੀ ਮਨਜ਼ੂਰੀਆਂ",
